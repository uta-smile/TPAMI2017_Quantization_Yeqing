function [ROC, mAP, Precision, tt0]=func_INHRE4h_weakLabel(traindata, testdata, knn_gnd, bit, range, P)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%% testing
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tV=W2*(testdata-repmat(mu2, [1 tn]));
tZ = R * tV; 
...
[ROC, Precision, mAP]=weak_HammingRanking(Y, tY, knn_gnd, range);

%%%% Hamming Radius 2 Hash Lookup
Y(find(Y<=0))=0;  tY(find(tY<=0))=0;
[HR2_Precision, success]=weak_HammingRadius2HashLookup(Y, tY, knn_gnd, range);
